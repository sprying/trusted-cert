const configuration = {
  ...
  host_add_no_install_operation_tip: '$ httpscert install',
  ...
  info_ssl_cert_trusted_cli_tip: '$ httpscert trust',
  info_extra_help: [
    '',
    '查看其它命令',
    '$ httpscert --help',
    '',
    '配置webpack的HTTPS证书示例',
    'https://github.com/sprying/httpscert#webpack',
    '配置nginx的HTTPS证书示例',
    'https://github.com/sprying/httpscert#nginx',
    '配置nodejs的HTTPS证书示例',
    'https://github.com/sprying/httpscert#nodejs',
    '如有疑问联系@慧知'
  ],
